    ...
    <footer className="bg-navy-900 text-white/70 mt-16">
      <div className="max-w-7xl mx-auto px-6 py-10 grid grid-cols-2 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li><a href="mailto:contact@ts-group.fr" className="flex items-center gap-2 hover:text-white transition-colors"><Mail size={13} />contact@ts-group.fr</a></li>
            <li><a href="tel:+224600000000" className="flex items-center gap-2 hover:text-white transition-colors"><Phone size={13} />+224 6XX XX XX XX</a></li>
          </ul>
        </div>
      </div>
      <div className="border-t border-white/10 py-4 px-6 flex flex-col sm:flex-row justify-between items-center gap-3 text-xs">
        <p>© {new Date().getFullYear()} <span className="text-white font-semibold">MyAppart</span> · TS Group · Tous droits réservés</p>
